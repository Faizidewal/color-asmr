...
namespace PaintIn3D
{
	...
	public class P3dPaintableManager : MonoBehaviour
	{
		...
		public static LinkedList<P3dPaintableManager> Instances { get { return instances; } }
		private static LinkedList<P3dPaintableManager> instances = new LinkedList<P3dPaintableManager>(); private LinkedListNode<P3dPaintableManager> instancesNode;
