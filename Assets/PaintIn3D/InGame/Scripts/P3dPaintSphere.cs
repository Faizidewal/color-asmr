...
namespace PaintIn3D
{
	...
	public class P3dPaintSphere : MonoBehaviour, IHit, IHitPoint, IHitLine, IHitTriangle, IHitQuad, IHitCoord
	{
		...
		[SerializeField] public P3dPaintableTexture targetTexture;
		...
		[SerializeField] public P3dBlendMode blendMode = P3dBlendMode.AlphaBlend(Vector4.one);
		...
		[SerializeField] private float hardness = 5.0f;
		...
		[SerializeField] public Texture tileTexture;
